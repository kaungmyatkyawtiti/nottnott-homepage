...
export const arts = [
  ...
  {
    description: "How to take notes in Markdown efficiently with Inkdrop",
    thumbnail: '/images/contents/youtube-how-to-use-inkdrop.jpg',
    href: '/',
  },
  {
    description: "My Fish workflow",
    thumbnail: '/images/contents/youtube-fish-workflow.jpg',
    href: '/',
  },
  {
    description: "My desk setup (Late 2020)",
    thumbnail: '/images/contents/youtube-my-desk-setup.jpg',
    href: '/',
  },
  {
    description: "How I’ve Attracted The First 500 Paid Users For My SaaS That Costs $5/mo",
    thumbnail: '/images/contents/blog-500-paid-users.jpg',
    href: '/',
  },
  {
    description: "I stopped setting a financial goal for my SaaS",
    thumbnail: '/images/contents/blog-financial-goal.png',
    href: '/',
  },
  {
    description: "How to Price Yourself as a Freelance Developer",
    thumbnail: '/images/contents/blog-how-to-price-yourself.jpg',
    href: '/',
  },
  {
    description: "I made my React Native app 50x faster",
